...
def histolog_multiples_r(Tableau1, Tableau2, Tableau3):
    ...
    plt.hist(Temps1, bins=logintervalles, density=1, alpha = 0.8, label=r'$r=%.1f$, $s_4 = %.3f$' %(r1, s4), color = couleurs[0])
    plt.hist(Temps2, bins=logintervalles, density=1, alpha = 0.8, label=r'$r=%.1f$, $s_4 = %.2f$' %(r2, s4_2), color = couleurs[1])
    plt.hist(Temps3, bins=logintervalles, density=1, alpha = 0.4, label=r'$r=%.1f$, $s_4 = %.3f$' %(r3, s4_3), color=couleurs[2])
    plt.xscale('log')
    ...
    plt.vlines(maxi1, ymin = 0, ymax = 0.175, color = couleurs[0], label = r'max ($r=%.1f$, $s_4=%.3f$)' %(r1, s4), linewidth = 5, alpha=0.7)
    plt.vlines(maxi2, ymin = 0, ymax = 0.175, color = couleurs[1], label = r'max ($r=%.1f$, $s_4=%.2f$)' %(r2, s4_2), linewidth = 5, alpha=0.7)
    plt.vlines(maxi3, ymin = 0, ymax = 0.175, color = couleurs[2], label = r'max ($r=%.1f$, $s_4=%.3f$)' %(r3, s4_3), linewidth = 5, alpha=0.7)
...
def histolog_multiples_f(Tableau1, Tableau2, Tableau3, Tableau4):
    ...
    plt.vlines(q99_3, ymin = 0, ymax = 0.2, color = couleurs[2], label = r'q99 ($f=%.1f$)' %f3, linestyles = 'dashed', linewidth = 6, alpha=0.7)
    plt.vlines(q99_4, ymin = 0, ymax = 0.2, color = couleurs[3], label = r'q99 ($f=%.1f$)' %f4, linestyles = 'dashed', linewidth = 5, alpha=0.7)
    plt.vlines(maxi1, ymin = 0, ymax = 0.2, color = couleurs[0], label = r'max ($f=%.d$)' %f1, linewidth = 4, alpha=0.7)
    plt.vlines(maxi2, ymin = 0, ymax = 0.2, color = couleurs[1], label = r'max ($f=%.1f$)' %f2, linewidth = 5, alpha=0.7)
    plt.vlines(maxi3, ymin = 0, ymax = 0.2, color = couleurs[2], label = r'max ($f=%.1f$)' %f3, linewidth = 5, alpha=0.7)
    plt.vlines(maxi4, ymin = 0, ymax = 0.2, color = couleurs[3], label = r'max ($f=%.1f$)' %f4, linewidth = 5, alpha=0.7)
