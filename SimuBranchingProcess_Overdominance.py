...
#============================
#Functions to compute matrices used to implement the branching process, in the partial overdominance case
#============================
...
def branchement_overdom(R, Tet, s3, s4, f, X0):
...
def echantillon_temps_parametres(R, Tet, s3, s4, f, X0, nb_trajectoires):
    ...
    for k in range(nb_trajectoires):
        ...
        les_Temps[k+nb_parametres] = branchement_overdom(R, Tet, s3, s4, f, X0)

    return les_Temps

#================================
#Commands used to generate datas for Figures S4 and S5
#================================
...
#Figure S4
#r=0.1, pin=0.5, s3=0.1, s4=0.001, f=0.5, X0=[1,0,0], nb_trajectoires=100000
#T_r01_s40001 = echantillon_temps_parametres([0.1, 0.1, 1, 1], [0.5, 0.5], 0.1, 0.001, 0.5, [1, 0, 0], 100000)
#r=0.5, pin=0.5, s3=0.1, s4=0.01, f=0.5, X0=[1,0,0], nb_trajectoires=100000
#T_r01_s01 = echantillon_temps_parametres([0.5, 0.5, 1, 1], [0.5, 0.5], 0.1, 0.01, 0.5, [1, 0, 0], 100000)
#r=0.5, pin=0.5, s=0.001, h=0.1, f=0.5, X0=[1,0,0], nb_trajectoires=100000
#T_r05_s01 = echantillon_temps_parametres([0.5, 0.5, 1, 1], [0.5, 0.5], 0.1, 0.001, 0.5, [1, 0, 0], 100000)


#Figure S5
#f=1, r=0.4, pin=0.5, s3=0.5, s4=0.01, X0=[1,0,0], nb_trajectoires=100000
#T_f1 = echantillon_temps_parametres([0.4, 0.4, 1, 1], [0.5, 0.5], 0.5, 0.01, 1, [1, 0, 0], 100000)
#f=0.9, r=0.4, pin=0.5, s3=0.5, s4=0.01, X0=[1,0,0], nb_trajectoires=100000
#T_f09 = echantillon_temps_parametres([0.4, 0.4, 1, 1], [0.5, 0.5], 0.5, 0.01, 0.9, [1, 0, 0], 100000)
#f=0.5, r=0.4, pin=0.5, s3=0.5, s4=0.01, X0=[1,0,0], nb_trajectoires=100000
#T_f05 = echantillon_temps_parametres([0.4, 0.4, 1, 1], [0.5, 0.5], 0.5, 0.01, 0.5, [1, 0, 0], 100000)
#f=0.1, r=0.4, pin=0.5, s3=0.5, s4=0.01, X0=[1,0,0], nb_trajectoires=100000
#T_f01 = echantillon_temps_parametres([0.4, 0.4, 1, 1], [0.5, 0.5], 0.5, 0.01, 0.1, [1, 0, 0], 100000)
